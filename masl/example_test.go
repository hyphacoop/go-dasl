...
func ExampleDocument_single_mode() {
  ...
  "x-my-app-version": "1.2.3"
	...
	if !maslDoc.IsBundle() {
		...
		fmt.Println(maslDoc.ContentType)
		// ...or as a resource
	...
	// custom-value
	// 1.2.3
	// 
}
	...
	bundle := `
{
  ...
  "resources": {
	...
	fmt.Println(rootResource.ContentType)
	...
	fmt.Println(jsResource.ContentType)
	...
	// Jane Doe
	// 1
	// 
}
...
func ExampleDocument_app_manifest() {
  ...
  "resources": {
	...
	fmt.Println(svgResource.ContentType)
	...
	// abc123def456
	// 1
	// 
}
...
func ExampleDocument_versioning() {
  ...
  "content-type": "text/html"
	...
	// text/html
	// false
	// 
}
